...
/// <summary>
/// Made by  DCordoba : https://answers.unity.com/questions/1629369/how-to-make-a-game-object-follow-a-drawn-path-at-r.html
/// </summary>
 ...
 public class LineFollower : MonoBehaviour {
     ...
     void Update () {
        if (completed) { return; }             
         if(lineToFollow != null && 0 < wayPoints.Length){
             if (smooth) { FollowSmooth (); }
             else { FollowClumsy (); }
         }
     }
